...
/* Services */
'use strict';
var middleAuditFeedbackListService=angular.module('middleAuditFeedbackListServices',['ngResource']);
var middleAuditFeedbackListUrl = '';
middleAuditFeedbackListService.factory('middleAuditFeedbackListFactory',function($resource){
   var middleAuditFeedbackListFactory;
   middleAuditFeedbackListFactory=$resource(middleAuditFeedbackListUrl,{},{
    ...
    return middleAuditFeedbackListFactory;
});
